...
| 2026-07-20 *(stamped; proof pending upgrade)* | 2026-07-20 | `rup-es-prereg-population-amd1` | `88f7ccfabe85cf664e0f7267060d64e08ea1892cd82359caf12913768e5cb908` | email-drafter study · amendment fixing a contamination flaw in the stamped labelling procedure: the human rater now sees ONLY the text, the corroborating fact is joined mechanically, and neither party computes the derived label — plus the verbatim frozen rule, a three-outcome scheme that refuses to force ambiguous cases, a span-quote requirement, and the primary rater's own exposure disclosed with its direction of bias named (stamped BEFORE any data was pulled) |
